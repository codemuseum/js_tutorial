...
if(arrowPosition=='left'){return{top:((target.outerHeight()-this.dialog.outerHeight())/2+targetPosition.top)+'px',left:(targetPosition.left+this.dialog.outerWidth()+this.dialogPad)+'px'};}
