...
if(arrowPosition=='bottom'){return{top:(targetPosition.top-this.dialog.outerHeight()-this.dialogPad)+'px',left:((target.outerWidth()-this.dialog.outerWidth())/2+targetPosition.left)+'px'};}
